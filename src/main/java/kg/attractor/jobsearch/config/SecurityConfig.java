    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/vacancies/*/applicants").hasRole("EMPLOYER")
                        ...
                        .requestMatchers(HttpMethod.GET, "/pages/vacancies/*").permitAll()
                        .requestMatchers(HttpMethod.GET, "/pages/companies/*").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/pages/responses").hasRole("APPLICANT")
                        .requestMatchers(HttpMethod.GET, "/pages/chats/*").authenticated()
                        .requestMatchers(HttpMethod.POST, "/pages/chats/*/messages").authenticated()
                        .requestMatchers(HttpMethod.POST, "/pages/chats/start").hasRole("EMPLOYER")

                        .requestMatchers("/js/**", "/styles/**", "/images/**").permitAll()
